...
def generate_image(upload_images, prompt, negative_prompt, style_name, num_steps, style_strength_ratio, num_outputs, num_reps, guidance_scale, seed, progress=gr.Progress(track_tqdm=True)):
    ...
    # generate some short id for session for output folder name
    folder_name = f"session_{random.randint(0, 1000000)}"
    save_images(images, "./out/" + folder_name)
...
with gr.Blocks(css=css) as demo:
    ...
    with gr.Row():
        with gr.Column():
            ...
            with gr.Accordion(open=False, label="Advanced Options"):
                ...
                num_outputs = gr.Slider(
                    label="Number of output images in one go",
                    minimum=1,
                    maximum=4,
                    step=1,
                    value=1,
        ...
        submit.click(
            ...
            fn=generate_image,
            inputs=[files, prompt, negative_prompt, style, num_steps, style_strength_ratio, num_outputs, num_reps, guidance_scale, seed],
